...
class Bootstrap_5_WP_Nav_Menu_Walker extends Walker_Nav_menu
{
  ...
  function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
  {
    ...
    /* if ( in_array( 'menu-item-video', $classes ) ) {
    ...
    $term_desc = term_description( $item->object_id);
    //$item_output .= '<p class="menu-item-description">'. $term_desc .'</p>';
    //if( $item->description) {
    $item_output .= $term_desc;
      //$item_output .= '<p class="menu-item-description">'.$item->description.'</p>';

    //}

    if ( in_array( 'featured-image', $classes ) ) {
