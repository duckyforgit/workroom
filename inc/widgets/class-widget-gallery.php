...
class Widget_Gallery extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'example',
			esc_html__( 'Widget Gallery', 'workroom1128' ),
			array(
				'classname'                   => 'workroom1128_widget_gallery',
		...
		// Add Action Comment add_action( 'save_post', array( $this, 'delete_widget_cache' ) );.
		// Add Action Comment add_action( 'deleted_post', array( $this, 'delete_widget_cache' ) );.
	...
	public function form( $instance ) {
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id( 'widget_title' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php esc_html_e( 'Title:', 'workroom1128' ); ?> 
		<input class="widefat" id="<?php echo $this->get_field_id( 'widget_title' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" name="<?php echo $this->get_field_name( 'widget_title' ); ?>" type="text" value="<?php echo esc_attr( $widget_title ); ?>" />
		</label>
		</p>
		<p>
		<label for="<?php echo $this->get_field_id( 'example_1' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php esc_html_e( 'Enter line 1', 'workroom1128' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'example_1' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" name="<?php echo $this->get_field_name( 'example_1' ); ?>" type="text" value="<?php echo $example_1; ?>" />
		</p>
		<p>
		<label for="<?php echo $this->get_field_id( 'example_2' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php esc_html_e( 'Enter line 1', 'workroom1128' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'example_2' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" name="<?php echo $this->get_field_name( 'example_2' ); ?>" type="text" value="<?php echo $example_2; ?>" />
		</p>
		<p>
		<label for="<?php echo $this->get_field_id( 'example_3' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?php esc_html_e( 'Enter line 1', 'workroom1128' ); ?></label>
		<input class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id( 'example_3' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" name="<?php echo $this->get_field_name( 'example_3' ); ?>" type="text" value="<?php echo $example_3; ?>" />
		</p>
		<?php
	}
