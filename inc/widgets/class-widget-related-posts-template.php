<?php
/**
 * Class Widget Related Posts Template
 *
 ...
 */
class Widget_Related_Posts_Template extends WP_Widget {
	 ...
	 *
	 * @param array $args Arguments may be optional.
					...
					<li>
						...
						<span class="media-object align-center-middle">
							<span class="media-object-section">
								<span class=" ">
									<?php echo esc_url( get_the_post_thumbnail($post->ID, 'thumbnail') ); ?>
								</span>
							</span>
