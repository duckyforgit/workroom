		...
		<h2 class="entry-header--hours " ><?php the_field( 'hour_location' ); ?></h2>
			<div class="business-hours business-hours--dark">
				<div class="content_wrapper">
					<table class="table table-hours"><tbody><tr><th scope="row">Monday</th><td><?php echo esc_html( $hours_monday ); ?></td></tr><tr><th scope="row">Tuesday</th><td><?php echo esc_html( $hours_tuesday ); ?></td></tr><tr><th scope="row">Wednesday</th><td><?php echo esc_html( $hours_wednesday ); ?></td></tr><tr><th scope="row">Thursday</th><td><?php echo esc_html( $hours_thursday ); ?></td></tr><tr><th scope="row">Friday</th><td><?php echo esc_html( $hours_friday ); ?></td></tr><tr><th scope="row">Saturday</th><td><?php echo esc_html( $hours_saturday ); ?></td></tr><tr><th scope="row">Sunday</th><td><?php echo esc_html( $hours_sunday ); ?></td></tr></tbody></table>
			</div>
		</div>
</div>
